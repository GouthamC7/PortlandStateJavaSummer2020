Name of the Assignment: Project4
...
options are -README, -print, -textFile file, -pretty file
...
If -pretty is specified it will pretty print all the calls in chronological order.